...
\sebsection{Without slot categorization}
Tabular \ref{tab:No time categorization results} shows the results for the models which use no time categorization.
\begin{table}[h]
\centering
...
\sebsection{With slot categorization}
