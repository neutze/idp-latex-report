...
Depending on the number of orders, the weighted moving average can have many weight sizes, as explained, and also the simple exponential smoothing has different $\alpha$. These  values for $\alpha$ are stepped up from 0.1 to 1 in 0.1 steps. In the result tables only the best result is shown in the table.
